...
- `Makefile` - replaced the shell-dependent `clean` recipe with a PowerShell-based cleanup command for more reliable Windows use; added `.PHONY` targets and a shared simulation output variable
